...
require_once __DIR__ . "/../includes/db_connection.php"; // ASUMSI: db_connection.php berisi koneksi $mysqli
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action == 'add_pegawai' || $action == 'edit_pegawai') {
        ...
        $id_dinas_selected = filter_var($_POST['id_dinas'] ?? '', FILTER_VALIDATE_INT); // Ini akan menjadi INT atau FALSE
        ...
        $nama_dinas_untuk_db = ''; // Inisialisasi kosong
        foreach ($list_dinas as $d) {
            // Menggunakan perbandingan '==' (non-strict) untuk menghindari masalah tipe data
