...
-- Generation Time: May 29, 2025 at 01:56 PM
...
(108, 9, '123456789123456789', '2025-05-29', '08:50:16', NULL, 'Hadir', NULL, NULL, NULL, 'Menunggu', '2025-05-29 12:50:16'),
(107, 93, '198010012005011001', '2025-05-29', '07:44:13', '07:52:11', 'Hadir', NULL, NULL, NULL, 'Menunggu', '2025-05-29 11:44:13');
...
(95, '-', 'test', '-', '-', 'test', 'Badan Kepegawaian dan Pengembangan Sumber Daya Manusia', 'Honor', NULL),
(9, '123456789123456789', 'HILMAN FARIZ FAUZA', 'admin', '3A', 'Superadmin', 'Sekretariat Daerah', 'PNS', NULL),
...
(96, '', 'test2', NULL, NULL, 'cleaning service', 'Badan Kepegawaian dan Pengembangan Sumber Daya Manusia', 'Honor', NULL);
...
(91, NULL, '198010012005011001', 5, 2025, 0, 0, 0, 0, 0, 0, 20, '0.00', '0.00'),
...
--
ALTER TABLE `absensi`
  MODIFY `id_absensi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
...
--
ALTER TABLE `pegawai`
  MODIFY `id_pegawai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;

--
-- AUTO_INCREMENT for table `rekapitulasi_bulanan`
--
ALTER TABLE `rekapitulasi_bulanan`
  MODIFY `id_rekap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
